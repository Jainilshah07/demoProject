    ...
    <div className='bg-zinc-700 py-8'>
            ...
            <div className="row grid grid-cols-2 mt-8 font-medium place-content-center">
                <div className="col-span-1 mx-auto">
                    <ul className='list-none text-white'>
                      ...
                      <Link to="/collections"><li className='flex mb-2'> <img src={sublist} alt="" /> <span className='pl-2'> Collections</span> </li></Link>
                      <Link to="/bonds"><li className='flex mb-2'> <img src={sublist} alt="" /> <span className='pl-2'>Bonds</span> </li></Link>
                    </ul>
                </div>
                <div className="col-span-1 mx-auto">
                    <ul className='list-none text-white'>
                      <Link to="/let's-learn"><li className='flex mb-2'> <img src={sublist} alt="" /> <span className='pl-2'>Beginner's Guide</span> </li></Link>
                      <Link to="/portfolio"><li className='flex mb-2'> <img src={sublist} alt="" /> <span className='pl-2'> Portfolio</span> </li></Link>
                      <Link to="/funds"><li className='flex mb-2'> <img src={sublist} alt="" /> <span className='pl-2'>Funds</span> </li></Link>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div className="lg:col-span-2 lg:mt-1 mt-8">
            ...
            <div className="row flex justify-center py-3">
                <div className="px-3">
                    <Link to="https://www.nseindia.com/products-services/about-corporate-bonds" target="_blank"> <img src={nse} alt="" /> </Link>
                </div>
                <div className="px-3">
