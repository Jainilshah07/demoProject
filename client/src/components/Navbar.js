    ...
    <nav className="flex items-center justify-between flex-wrap bg-zinc-700 border-b-[1.5px] border-black p-2 text-[16px]">
      ...
      <div className={`w-full lg:ml-60 mx-2 block flex-grow lg:flex lg:items-center lg:w-auto ${open ? '' : 'hidden'}`}>
        <div className="text-sm lg:flex-grow mt-4 lg:text-center font-[Montserrat] font-extrabold">
          {/* <img src={logo}/> */}
          <Link to="/collections" className="block lg:inline-block text-base lg:mt-0 text-white hover:bg-gray-200 p-2 hover:rounded-full mr-4 lg:mr-8 float-left">
            <span>Collections</span>
          </Link>
          <Link to="/bonds" className="block lg:inline-block text-base lg:mt-0 text-white hover:bg-gray-200 p-2 hover:rounded-full mr-4 lg:mr-8 float-left">
            <span>Bonds</span>
          </Link>
          ...
          <Link to="/funds" className="block lg:inline-block text-base lg:mt-0 text-white hover:bg-gray-200 p-2 hover:rounded-full mr-4 lg:mr-8 float-left">
            <span>Wallet</span>
          </Link>
